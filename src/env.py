...
class LaneChangeEnv(gym.Env):
    ...
    def _setup_traffic(self):
        ...
        for i in range(num_obstacles):
            ...
            try:
                traci.vehicle.add(obs_id, 'r0', typeID='obstacle', departPos=str(pos), departLane=str(lane))
    ...
    def _get_obs(self):
        try:
            ...
            d_front_left, d_back_left = get_lane_dists(ego_lane + 1) if ego_lane < 1 else (0, 0) # 0 indicates wall/invalid
